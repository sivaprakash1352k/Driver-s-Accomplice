...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        builder.setTitle("Driver's Accomplice Error")
    ...
    public void allEyesOpened(AllEyesOpenedEvent event) {
        ...
        //Toast.makeText(getApplicationContext(), d+currentTime,
          //      Toast.LENGTH_LONG).show();

        //File root = new File("");
        File gpxfile = new File(d , "drowsy_data.txt");
        try {
            FileWriter writer = new FileWriter(gpxfile,true);
            writer.append(currentDate+":"+currentTime);
            //writer.flush();
            writer.append("/");
            writer.close();
